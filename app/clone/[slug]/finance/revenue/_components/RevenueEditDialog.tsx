...
import { updateRevenue, type RevenueInput } from "../_actions";

interface Props {
  slug: string;
  tenantId: string;
  revenueId: string;
  initial: RevenueInput;
}
...
export function RevenueEditDialog({
  slug,
  tenantId,
  revenueId,
  initial,
  ...
  const [form, setForm] = useState<RevenueInput>(initial);
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    startTransition(async () => {
      const res = await updateRevenue(slug, tenantId, revenueId, form);
      if (!res.ok) {
