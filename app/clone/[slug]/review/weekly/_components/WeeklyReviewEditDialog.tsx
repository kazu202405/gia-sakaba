...
import { updateWeeklyReview, type WeeklyReviewInput } from "../_actions";
...
export function WeeklyReviewEditDialog({
  slug,
  tenantId,
  reviewId,
  initial,
  ...
  const [form, setForm] = useState<WeeklyReviewInput>(initial);
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    startTransition(async () => {
      const res = await updateWeeklyReview(slug, tenantId, reviewId, form);
      if (!res.ok) {
