  ...
  return <div className="grid gap-6 lg:grid-cols-[1fr_0.72fr] lg:items-start">
    <Window title="新規登録">
      ...
      <form onSubmit={submit} className="space-y-4">
        ...
        <button type="submit" disabled={busy || preview} className="rpg-button h-12 w-full text-sm disabled:opacity-50">{preview ? "プレビュー中（送信できません）" : busy ? "登録中…" : "▶ アカウントを作成して次へ"}</button>
      </form>
    </Window>
