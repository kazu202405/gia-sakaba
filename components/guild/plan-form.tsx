...
export function PlanForm({ role, billingStatus, isPaid, hasCustomer, checkoutResult }: Props) {
  ...
  return <div className="space-y-9">
    ...
    <PageTitle title="有料会員" lead={`${ENTRY_PLAN_PRICE_LABEL}。交流（名鑑・クエスト・しょうかい）は無料のままです。`} />
    ...
    {exempt ? <Window title="会員の状態">
      ...
      {billingStatus === "past_due" ? <>
        ...
        <p className="text-[15px] leading-relaxed">{ENTRY_PLAN_PRICE_LABEL}の月額会員です。無料体験期間はありません。</p>
